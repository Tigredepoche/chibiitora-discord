...
exports.config = {
    ...
    providers: {
        ...
        */
        ...
        firestore: 
        { 
            credentials:'chibiitorav2-firebase-adminsdk-4dyhe-119fe0c95f.json', 
            databaseURL: 'https://chibiitorav2.firebaseio.com'}
        },
     ...
     */
    gateways: {
        guilds: { Provider: 'firestore'},
        users: { Provider: 'firestore'},
        clientStorage: { Provider: 'firestore'},
    },
